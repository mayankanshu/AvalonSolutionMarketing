<%@ WebHandler Language="C#" Class="RetailerInvitation" %>
...
public class RetailerInvitation : IHttpHandler, IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        //objSupplierRequestManager.SaveSupplierRequestDetails(RetailCompName, RetailCity, RetailState, RetailZip, RetailerPhone, RetailerExtn, RetailerEmailId, RetailerWebsite,
        //                                                     SupplierCompName, SupplierCity, SupplierState, SupplierZip,SupplierPhone, SupplierExtn, SupplierEmailId, SupplierWebsite, SupplierContTitle, SupplierContName, SupplierConPos, SupplierConMob,
        //                                                     SupplierConEmailId, Comments, ipAddress, ipLocation);
    ...
    protected void sendRetailerEmail()
    {
        ...
        Mailer.Subject = replaceLocalVariable("JewelExchange Invitation sent to" + " - " + SupplierCompName + " - " + SupplierCity + ", " + SupplierState + " - " + " " + "[DATE]");
        Mailer.Body = replaceLocalVariable(this.readHtmlPage(Constants.Web_Root + "/EmailPages/RetailerInvitation/RetailerCopy.html"));
    ...
    protected void sendSupplierEmail()
    {
        ...
        Mailer.Subject = replaceLocalVariable("JewelExchange Inventory Access Request Received From" + " " + RetailCompName + " - " + RetailCity + ", " + RetailState + " - " + " " + "[DATE]");
        Mailer.Body = replaceLocalVariable(this.readHtmlPage(Constants.Web_Root + "/EmailPages/RetailerInvitation/SupplierCopy.html"));
    ...
    protected void sendAvalonEmail()
    {
        ...
        MailMessage Mailer = new System.Net.Mail.MailMessage(sMailFrom, sMailTo);
        Mailer.Subject = replaceLocalVariable("JewelExchange" + " - " + RetailCompName + " - " + RetailCity + ", " + RetailState + " " + "invited" + " " + SupplierCompName + " - " + SupplierCity + ", " + SupplierState + " " + "to Join");
        Mailer.Body = replaceLocalVariable(this.readHtmlPage(Constants.Web_Root + "/EmailPages/RetailerInvitation/AvalonCopy.html"));
    ...
    protected String replaceLocalVariable(string strBody)
    {
        ...
        strBody = strBody.Replace("[SuppliersContPerName]", SupplierContName);
