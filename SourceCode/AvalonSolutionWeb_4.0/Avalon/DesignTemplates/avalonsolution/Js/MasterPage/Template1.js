...
$(document).ready(function () {
    ...
    $("#containerHeader").setParam('SignUpUrl', sitesetting.webRoot + '/SignUp/SignUp.aspx');
    $("#containerHeader").setParam('FeaturesUrl', sitesetting.webRoot + '/Features/Features.aspx');
    $("#containerHeader").setParam('ProductManagementUrl', sitesetting.webRoot + '/Features/Product_Management.aspx');
    $("#containerHeader").setParam('ContentManagementUrl', sitesetting.webRoot + '/Features/Content_Management.aspx');
    $("#containerHeader").setParam('DiamondFeedUrl', sitesetting.webRoot + '/Features/Diamond_Feed.aspx');
    $("#containerHeader").setParam('JewelExchangeUrl', sitesetting.webRoot + '/Features/JewelExchange.aspx');
    $("#containerHeader").setParam('MobileWebsiteUrl', sitesetting.webRoot + '/Features/Mobile_Website.aspx');
    $("#containerHeader").setParam('ShoppingCartUrl', sitesetting.webRoot + '/Features/Shopping_Cart.aspx');
    $("#containerHeader").setParam('BrandCustomization', sitesetting.webRoot + '/Features/Brand_Customization.aspx');

    //$("#containerHeader").setParam('HomePageURL', sitesetting.webRoot);
    $("#containerHeader").setParam('ServicesUrl', sitesetting.webRoot + '/Services/Services.aspx');
    $("#containerHeader").setParam('MarketingSEO', sitesetting.webRoot + '/Services/Marketing_SEO.aspx');
    $("#containerHeader").setParam('SocialMedia', sitesetting.webRoot + '/Services/Social_Media.aspx');
    $("#containerHeader").setParam('EmailMarketing', sitesetting.webRoot + '/Services/Email_Marketing.aspx');
    $("#containerHeader").setParam('EmailTemplates', sitesetting.webRoot + '/Services/Email_Templates.aspx');
    $("#containerHeader").setParam('AddOnModules', sitesetting.webRoot + '/Services/Add-on_Modules.aspx');
    $("#containerHeader").setParam('DigitalECatalog', sitesetting.webRoot + '/Services/Digital_ECatalog.aspx');
    $("#containerHeader").setParam('WebHosting', sitesetting.webRoot + '/Services/Web_Hosting.aspx');
    $("#containerHeader").setParam('Domains', sitesetting.webRoot + '/Services/Domains.aspx');
    $("#containerHeader").setParam('SSL', sitesetting.webRoot + '/Services/SSL.aspx');

    $("#containerHeader").setParam('PortfolioUrl', sitesetting.webRoot + '/Portfolio/Portfolio.aspx');
    $("#containerHeader").setParam('WebsiteDesigns', sitesetting.webRoot + '/Portfolio/Website_Designs.aspx');
    $("#containerHeader").setParam('ResponsiveDesigns', sitesetting.webRoot + '/Portfolio/Responsive_Designs.aspx');
    $("#containerHeader").setParam('Customization', sitesetting.webRoot + '/Portfolio/Customization.aspx');
    $("#containerHeader").setParam('RetailStorefronts', sitesetting.webRoot + '/Portfolio/Retail_Storefronts.aspx');
    $("#containerHeader").setParam('ProductPresentation1', sitesetting.webRoot + '/Portfolio/Product_Presentation.aspx');

    $("#containerHeader").setParam('PricingUrl', sitesetting.webRoot + '/Pricing/Pricing.aspx');

    $("#containerHeader").setParam('ClientsUrl', sitesetting.webRoot + '/Clients/Clients.aspx');
    $("#containerHeader").setParam('Benefits', sitesetting.webRoot + '/Clients/Benefits.aspx');
    $("#containerHeader").setParam('Customers', sitesetting.webRoot + '/Clients/Customers.aspx');
    $("#containerHeader").setParam('Testimonials', sitesetting.webRoot + '/Clients/Testimonials.aspx');
    $("#containerHeader").setParam('WhyOnline', sitesetting.webRoot + '/Clients/Why_Online.aspx');

    $("#containerHeader").setParam('CompanyUrl', sitesetting.webRoot + '/Company/Company.aspx');
    $("#containerHeader").setParam('AboutUs', sitesetting.webRoot + '/Company/About_Us.aspx');
    $("#containerHeader").setParam('News', sitesetting.webRoot + '/Company/News.aspx');
    $("#containerHeader").setParam('Partners', sitesetting.webRoot + '/Company/Partners.aspx');
    $("#containerHeader").setParam('ProductPresentation', sitesetting.webRoot + '/Company/Product_Presentation.aspx');
    $("#containerHeader").setParam('TradeShows', sitesetting.webRoot + '/Company/Trade_Shows.aspx');


    $("#containerHeader").setParam('SupportUrl', sitesetting.webRoot + '/Support/Support.aspx');
    $("#containerHeader").setParam('Downloads', sitesetting.webRoot + '/Support/Downloads.aspx');
    $("#containerHeader").setParam('KnowledgeBase', sitesetting.webRoot + '/Support/Knowledge_Base.aspx');
    $("#containerHeader").setParam('SubmitATicket', sitesetting.webRoot + '/Support/Submit_A_Ticket.aspx');
    $("#containerHeader").setParam('SupportRequest', sitesetting.webRoot + '/Support/Support_Request.aspx');
    
    $("#containerHeader").setParam('ContactUs', sitesetting.webRoot + '/ContactUs/ContactUs.aspx');
  ...
  //  $("#containerHeader").setParam('HomePageURL', sitesetting.WebRoot + '/Index.aspx');
  ...
  //  $("#containerHeader").setParam('HomePageURL', sitesetting.WebRoot + '/Index.aspx');
    ...
    $("#containerHeader").setParam('TrackMyOrder', sitesetting.WebRoot + '/SecureSSL/OrderTracking/FindOrder.aspx');
    ...
    $("#containerFooter").setParam('PrivacyPolicy', sitesetting.webRoot + '/PrivacyPolicy');
    $("#containerFooter").setParam('TermsOfUse', sitesetting.webRoot + '/TermsOfUse/TermsOfUse.aspx');
    ...
    $("#containerFooter").setParam('TrackMyOrder', sitesetting.WebRoot + '/SecureSSL/OrderTracking/FindOrder.aspx');
 ...
 ////////////////////START FOOTER REQUEST CALL BACK FUNCTION//////////////////////
    ...
    $('#txtComment_text').html(text_Description + ' characters remaining');
    var text_length = $('#txtCommentsDemo').val().length;
    var text_remaining = text_Description - text_length;
    $('#txtComment_text').html(text_remaining + ' characters remaining');

    $('#txtCommentsDemo').keyup(function () {
        var text_length = $('#txtCommentsDemo').val().length;
        var text_remaining = text_Description - text_length;
    ...
    $("#btnScheduleDemo").click(function () {
        ...
        var Comments = $("#txtCommentsDemo").val();
        ...
        if (isValid == true) {
            ...
            var url = sitesetting.AvalonDataServicesPath + "ScheduleDemo/ServicePages/ScheduleDemo.ashx?FullName=" + FullName + "&Email=" + Email + "&Phone=" + Phone + "&Company=" + Company + "&WebsiteUrl=" + WebsiteUrl + "&DemoDate=" + DemoDate + "&DemoTime=" + DemoTime + "&Comments=" + Comments + "&JobTitle=" + JobTitle + "&TimeZone=" + TimeZone;
